(function(global, factory) {
  ...
  function template(content, flags) {
    ...
    return () => {
      ...
      var clone = use_import_node ? document.importNode(node, true) : /* @__PURE__ */ clone_node(node, true);
      push_template_node(
        is_fragment ? (
  ...
  function html_to_dom(target, effect2, value, svg) {
    var html2 = value + "";
    if (svg)
      html2 = `<svg>${html2}</svg>`;
