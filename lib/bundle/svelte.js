(function(global, factory) {
  ...
  function each(node, flags, get_collection, get_key, render_fn, fallback_fn = null) {
    ...
    block(() => {
      ...
      was_empty = length === 0;
      {
        ...
        reconcile(array, state, anchor, render_fn, flags, (effect2.f & INERT) !== 0, get_key);
      }
      if (fallback_fn !== null) {
        if (length === 0) {
          if (fallback) {
  ...
  const get_props_with_getter = (key, get2) => {
    return {
      [key]: () => get2()
    };
  };
  const set_props_getter = (props, key, get2) => {
    Object.defineProperty(props, key, { get: get2 });
  };
  const svelte = {
    get_props_with_getter,
    set_props_getter,
    await_block,
    each,
    html,
