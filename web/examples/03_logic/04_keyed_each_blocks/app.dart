...
void App(Node $$anchor, AppProperties $$properties) {
  ...
  $.eachBlock(node, 1, () => $.get(things), (thing, index) => thing.id.toJS, ($$anchor, thing, index) {
    Thing($$anchor, $.getPropertiesWithGetter<ThingProperties>('current', () => $.ref($.get(thing).color)));
  });
